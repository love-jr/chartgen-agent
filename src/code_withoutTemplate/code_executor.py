...
#     try:
#         # 2. 写入临时文件  
#         temp_file_path = f'/data/yangyuming/projects/chart_generation/chart+{model_name}/chart_{index:04d}/temp_code.R'
...
#         chart_subfolder_path = f'/data/yangyuming/projects/chart_generation/chart+{model_name}/chart_{index:04d}'
