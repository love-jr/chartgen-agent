...
def save_generated_data(generated_data: str, index: int, model_name: str):
    ...
    chart_folder_path = '/data/yangyuming/projects/chart_generation/chartWithTemplate'+ '+' + model_name
    ...
    try:
        ...
        print(f"保存数据失败: {e}")
# def save_generated_data(generated_data: str, index: int):
#     """将生成的数据保存为 JSON 文件"""
#     # 创建 chart 文件夹及子文件夹

#     chart_folder_path = '/data/yangyuming/projects/chart_generation/chartWithTemplate'
#     os.makedirs(chart_folder_path, exist_ok=True)
